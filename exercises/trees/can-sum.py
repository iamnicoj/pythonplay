...
def _best_sum_v2(target, numarray, memo={}):
    ...
    for num in numarray:
        ...
        # when modifying list of objects on a python recursive call
        # MAKE A FUKING DEEP COPY as it will be always referencing the objects 
        # and not the values
